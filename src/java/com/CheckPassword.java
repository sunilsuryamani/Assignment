...
public class CheckPassword extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Check-Password-Page</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            PreparedStatement ps=con.prepareStatement("select password from employee where password='"+ password +"' or email_id='"+ email +"' ");
            ResultSet rs =ps.executeQuery();
            if(rs.next()){

              out.println("<h2><font color='red'>Password and Email id Must be Unique</font></h2>");
